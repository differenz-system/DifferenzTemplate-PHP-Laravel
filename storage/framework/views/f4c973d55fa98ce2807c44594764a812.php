                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="ibox float-e-margins">
                            ...
                            <div>
                                <form action="<?php echo e(url('admin/updateprofileimage')); ?>" method="POST" enctype="multipart/form-data" >
                                    <?php echo csrf_field(); ?>
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label class="cabinet center-block">
                                            <figure>
                                                <?php if($admin->ProfilePicture == '' || $admin->ProfilePicture == null): ?>
                                                    <?php $Image = asset('storage/admin/images/profile/user-not-found.png') ?>
                                                <?php else: ?>
                                                    <?php if(file_exists(storage_path('admin/images/profile/'.$admin->ProfilePicture))): ?>
                                                        <?php $Image = asset('storage/admin/images/profile').'/'.$admin->ProfilePicture ?>
                                                    <?php else: ?>
                                                        <?php $Image = asset('storage/admin/images/profile/user-not-found.png') ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>  
                    ...
                    <div class="col-lg-8">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">    
                                <form id="admin-change-password" name="admin-change-password" action="<?php echo e(url('admin/changepassword')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="profile-wall-textbox">
                                        <?php if(Session::has('change-message')): ?>
                                            <p id="msgs" class="alert alert-success"><?php echo e(Session::get('change-message')); ?></p>
                                        <?php endif; ?> 
                                    </div>
